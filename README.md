...
- **Funcionalidade (50%)**: O código executa corretamente e resolve o problema proposto
- **Lógica (30%)**: A solução é eficiente e bem estruturada
- **Organização (10%)**: O código está organizado, bem comentado e legível
- **Completude (10%)**: Todos os exercícios foram resolvidos

Nota máxima: 100 pontos (+ 20 pontos extras opcionais)
